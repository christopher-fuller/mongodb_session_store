...
Rails must already be configured for MongoDB. Using an object mapper (ODM), such as Mongoid[http://mongoid.org/] or MongoMapper[http://mongomapper.com/], is entirely optional.
