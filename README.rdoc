...
Stores Rails sessions in a MongoDB[http://mongodb.org/] with configurable options including optional garbage-collection. Use with or without a MongoDB object mapper (ODM).
