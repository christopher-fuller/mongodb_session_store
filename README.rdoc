...
Stores Rails sessions in a MongoDB[http://mongodb.org/] collection with configurable options including optional garbage-collection. Use with or without a MongoDB object mapper (ODM).
...
<b>Session Expiration (for garbage-collection) [in seconds]:</b>
