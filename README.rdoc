...
Stores Rails sessions in a MongoDB[http://mongodb.org/] collection with configurable options including garbage-collection. Use with or without a MongoDB object mapper (ODM).
